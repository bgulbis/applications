...
total_score <- data_demog %>%
    ...
    arrange(desc(score_adj), desc(score_app_median))
...
df <- total_score %>%
    ...
    # unite(remark_all) %>%
    select(app_name, school, gpa, score_adj, score_bullet, comb_remark_all, low_remarks, score_adj_app_median, comb_a_score, score_adj_vid_median, comb_v_score, interest_1, interest_2, interest_3) %>%
