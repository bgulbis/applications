...
data_demog <- raw_apps %>%
    ...
    mutate_at(
        "school_abbrev", 
        str_replace_all, 
        pattern = " - STATE UNIV OF NEW JERSEY - NEW BRUNSWICK| - FORT WORTH| - UNIV PARK| - LAKE ERIE COLLEGE OF OSTEOPATHIC MEDICINE AND SCHOOL OF PHARMACY - BRADENTON, FL| OF MEDICINE AND SCIENCE| - DENVER AND HSC| - BOTHELL CAMPUS/SEATTLE CAMPUS/TACOMA CAMPUS| FOR MEDICAL SCIENCES| - CHAPEL HILL", 
        replacement = ""
    )
