...
raw_apps <- read_csv(paste0(f, "raw/pgy1_application_scores_fy25.csv"))
...
data_app_scores <- raw_apps |>
    ...
    mutate(
        ...
        across(name, str_replace_all, pattern = "question_interview_1_yes_0_no_", replacement = "interview")
    ) |> 
...
openxlsx::write.xlsx(
    total_score,
    paste0(f, "final/2025_applications.xlsx")
)
